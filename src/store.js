...
export const store = reactive({
    source: [
        {
            "type": "image",
            "icon": "/icon/ico-neve.png",
            "url": "images/gremlins.gif"
        },
        {
            "type": "image",
            "icon": "/icon/ico-albero.png",
            "url": "images/friends.gif"
        },
        {
            "type": "text",
            "icon": "/icon/ico-fiocco.png",
        ...
        {
            "type": "image",
            "icon": "/icon/ico-stella.png",
            "url": "images/homealone.gif"
        },
        {
            "type": "text",
            "icon": "/icon/ico-omino.png",
